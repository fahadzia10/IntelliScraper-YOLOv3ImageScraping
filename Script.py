...
def main(args):
	...
	parser.add_argument('-s', '--search', required = True, default='bananas', type=str, help='search term')
	parser.add_argument('-n', '--num_images', default=10, type=int, help='num images to save')
	#parser.add_argument('-d', '--directory', default='/Users/Fahad/Desktop/', type=str, help='save directory')
	args = parser.parse_args()
	query = args.search#raw_input(args.search)
	max_images = args.num_images
    
	file_path = '/Users/Fahad/Desktop/IntelliScraper/Images/'+query+'/'
